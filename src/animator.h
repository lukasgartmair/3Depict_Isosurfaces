...
class FrameProperties
{
	...
	public:
		...
		void setInterpMode(size_t mode) {ASSERT(mode<INTERP_END); interpData.interpMode=mode;}
...
class PropertyAnimator
{
	...
	public:
		...
		void getNthKeyFrame(size_t frameNum,FrameProperties &f) const { ASSERT(frameNum < keyFrames.size()); f=keyFrames[frameNum];};
