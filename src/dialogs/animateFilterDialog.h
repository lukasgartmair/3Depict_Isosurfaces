...
private:
    ...
    //!Default height/width desired for output imgaes
    ...
    //!True if the user has requetsed ion data out[ut
    bool wantIonOutput;
    ...
    void updateOKButton();
    //update function for filter view page, grid control
